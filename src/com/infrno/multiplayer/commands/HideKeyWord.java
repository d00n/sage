...
public class HideKeyWord implements ChatExpression {
	public static Evaluator createEvaluator( ) {
		return new HideKeyWordEvaluator( );
	}
...
class HideKeyWordEvaluator implements Evaluator {
	private static Pattern m_pattern = Pattern.compile( "^hide$", Pattern.CASE_INSENSITIVE );
