...
public class RKeyWord implements ChatExpression {
	public static Evaluator createEvaluator( ) {
		return new RKeyWordEvaluator( );
	}
...
class RKeyWordEvaluator implements Evaluator {
	private static Pattern m_pattern = Pattern.compile( "^r$", Pattern.CASE_INSENSITIVE );
